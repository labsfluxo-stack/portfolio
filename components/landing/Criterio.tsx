...
export function Criterio({ dict, locale }: { dict: Dictionary; locale: Locale }) {
  ...
  return (
    // A SEÇÃO ESCURECEU, E A AUDITORIA INTEIRA VEIO JUNTO DE GRAÇA.
    //
    // O formulário da auditoria tem umas trinta classes de polaridade clara —
    // `text-ink`, `bg-paper`, `border-rule`, `placeholder:text-ink-2/60`, além
    // das dezenas do painel de resultado. Reescrever todas seria trabalho
