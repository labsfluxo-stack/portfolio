...
export const en: Dictionary = {
  ...
  ativacoes: {
    meta: {
      ...
      description:
        'Custom software behind your activation: advergame, quiz, prize wheel, kiosk and live screen. It ships under the agency brand.',
    },
    capa: {
      titulo: 'The activation is yours.',
      tituloDestaque: 'The code is ours.',
      subtitulo:
        'The software for the activation your agency sold, built to order.',
